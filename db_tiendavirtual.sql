...
-- Tiempo de generación: 24-08-2022 a las 19:50:50
...
(1, 'Hombre', 'Los mejores diseños', 'img_1c2e1797373091ce6872488da7af375c.jpg', '2021-08-20 03:04:04', 'hombre', 1),
(2, 'Diseños propios', 'Arma tu propio estilo', 'img_1b327019a52018256787e01f54c72e7a.jpg', '2021-08-21 00:47:10', 'disenos-propios', 1),
(3, 'Proximamente', 'chaquetas unicas', 'img_5566e2ee2e64a964d4ac28b4a1ffa41b.jpg', '2022-08-21 17:39:10', 'proximamente', 1);
...
(1, 'flychil', 'andres.fffz94@gmail.com', 'mensaje de prueba de suscripcion', '127.0.0.1', 'PC', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:91.0) Gecko/20100101 Firefox/91.0', '2022-07-21 04:06:18'),
(2, 'Andres', 'ncsdncs@gmail.com', 'pruebaerror 1', '::1', 'PC', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36', '2022-08-21 17:15:00');
...
(16, 4, 'pro_8a5a26a8481881a8adcc92ce7dbba0e5.jpg'),
(17, 1, 'pro_62aaf9e1c66665767951c95813fa10d4.jpg'),
(18, 1, 'pro_e4f7ecf02d9023a2ae3f1601548d20b8.jpg'),
(19, 5, 'pro_e6fad6453693e023b38d968f9041511f.jpg'),
(20, 6, 'pro_a97ccd15ddf232bfdaae9246d63ebe45.jpg'),
(21, 6, 'pro_028751d97e4b0eabfbbd8effedfb9193.jpg'),
(22, 7, 'pro_580ec42a3f7127ffd002b7f85e08facb.jpg'),
(23, 7, 'pro_b8e58b732d55f9666441824639fd4cae.jpg');
...
(3, NULL, NULL, NULL, 6, '2022-08-22 09:26:54', '5.00', '20005.00', 2, 'asd, asd', 'Pendiente'),
(4, NULL, NULL, NULL, 6, '2022-08-22 09:27:42', '5.00', '62005.00', 3, 'asd, aad', 'Pendiente');
...
(1, '1146439086', 'Yovan', 'Cardenas', 3137858702, 'yovan-14@hotmail.com', '0b36980af5c0346a818b88693526bc0deb1e8ed19cba03824cc6db1110c331db', 'CF', 'Abel OSH', 'Ciudad', NULL, 1, '2021-08-20 01:34:15', 1),
...
(4, '1020463848', 'Andres Felipe', 'Franco', 3216151559, 'andres.fffz94@gmail.com', '4ef46087a83f963102bfe677a4ce522fb25c64f0e478336beed27d13ffbac721', NULL, NULL, NULL, NULL, 1, '2021-08-21 18:07:00', 1),
(6, '1000759100', 'Santiago', 'Gutierrez', 3012586175, 'gutisantiago2@gmail.com', 'f77a6b134bf6a7c561f75faae34447d6dde0beb822cf73e5af0746d6250d5b56', NULL, NULL, NULL, NULL, 1, '2022-08-21 18:30:10', 1);
...
(2, 'Tienda', '<p>Contenido p&aacute;gina!</p>', 'img_948cab73272d1b29f4e872cd74a7674d.jpg', '2021-08-06 01:21:27', 'tienda', 1),
(3, 'Carrito', '<p>Contenido p&aacute;gina!</p>', '', '2021-08-06 01:21:52', 'carrito', 1),
(4, 'Un poco de Flychill', '<section class=\"bg0 p-t-75 p-b-120\"> <div class=\"container\"> <div class=\"row p-b-148\"> <div class=\"col-md-7 col-lg-8\"> <div class=\"p-t-7 p-r-85 p-r-15-lg p-r-0-md\"> <h3 class=\"mtext-111 cl2 p-b-16\">Historia</h3> <p class=\"stext-113 cl6 p-b-26\">El 23 de noviembre del 2021 Manuela Mu&ntilde;oz fund&oacute; FLYCHILL, con la idea de llevar a cabo un estilo urbano para que los jovenes se vistieran bien sin ser mal vistos por la sociedad, despu&eacute;s de mucho trabajo y esfuerzo, en enero del 2022 saco sus primeras prendas de vestir a la venta, esta primera colecci&oacute;n se llama CREW FRESH, en esta colecci&oacute;n se sacaron 4 dise&ntilde;os, 2 camisetas blancas y dos negras, ambas con dos dise&ntilde;os unicos, una con el nombre de la marca y la otra con el logo. Esta colecci&oacute;n fue un exito total, se realizaron muchas ventas en los primeros d&iacute;as de salir a la venta.</p> </div> </div> <div class=\"col-11 col-md-5 col-lg-4 m-lr-auto\"> <div class=\"how-bor1 \"> <div class=\"hov-img0\"><img src=\"https://cdn.pixabay.com/photo/2015/07/17/22/43/student-849825_1280.jpg\" alt=\"IMG\" width=\"500\" height=\"333\" /></div> <div class=\"hov-img0\">&nbsp;</div> </div> </div> </div> <div class=\"row\"> <div class=\"order-md-2 col-md-7 col-lg-8 p-b-30\"> <div class=\"p-t-7 p-l-85 p-l-15-lg p-l-0-md\"> <h2 class=\"mtext-111 cl2 p-b-16\"><span style=\"color: #236fa1;\">&iquest;Quieres ser parte de nuestro equipo?</span></h2> <p><span style=\"color: #000000;\">Envi</span><span style=\"color: #000000;\">anos tu hoja de vida </span><span style=\"color: #000000;\">y si cumples con algunas de nuestras vacantes, te llamaremos.</span></p> <div class=\"bor16 p-l-29 p-b-9 m-t-22\">&nbsp;</div> </div> </div> <div class=\"order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30\"> <div class=\"how-bor2\"> <div class=\"hov-img0\"><img src=\"https://www.micarrera.com/wp-content/uploads/2018/04/equipodetrabajo.jpg\" alt=\"IMG\" width=\"486\" height=\"305\" /></div> <div class=\"hov-img0\">&nbsp;</div> <div class=\"hov-img0\">&nbsp;</div> </div> </div> </div> </div> </section>', 'img_8debd738f80888e77af21a41198bfc7e.jpg', '2021-08-09 03:09:44', 'nosotros', 1),
(5, 'Contacto', '<p>.</p>', 'img_338dfccc193cebfc8a59085134870948.jpg', '2021-08-09 03:11:08', 'contacto', 1),
(6, 'Preguntas frecuentes', '<ol> <li><strong>&iquest;Cu&aacute;l es el tiempo de entrega de los producto?&nbsp;</strong>Depender&aacute; de la ubicacion en la que te encuentres, envios nivel departamentel 2 dias, nivel nacional de 3 a 5 dias</li> <li><strong>&iquest;C&oacute;mo es la forma de env&iacute;o de los productos?</strong> Nuestros envios, son exclusivos por clientes, si nuestro cliente que sea un regalo para alguien mas se le har&aacute; el empaque tal cual lo requiere, en tal caso nuestro producto ir&aacute; en una peque&ntilde;a caja de referencia de nuestra marca</li> <li><strong>&iquest;Cu&aacute;l es el tiempo m&aacute;ximo para solicitar un reembolso?</strong> El tiempo maximo de reembolso de 10 a 15 dias, despues de no haber cumplido los estandares de calidad y satisfacion del cliente.</li> </ol> <p>&nbsp;</p> <p>Otras preguntas</p> <ul> <li><strong>&iquest;Qu&eacute; formas de pago aceptan?&nbsp;</strong> <ul> <li>Tarjetas credito mastercard y visa</li> </ul> </li> </ul>', 'img_9a660f3a8c84fb3c43ba7c890c00ca13.jpg', '2021-08-11 01:24:19', 'preguntas-frecuentes', 1),
...
(1, 1, '123456789', 'Camiseta algodon', '<p>Camiseta en algodon 100% , estampacion en textil</p>', '36000.00', 50, NULL, '2021-08-20 03:12:14', 'camiseta-algodon', 1),
...
(4, 1, '12364', 'CAMISETA BLANCO', '<p>CAMISETA EN ALGODON 100%&nbsp;</p>', '35000.00', 15, NULL, '2022-08-15 13:31:45', 'camiseta-blanco', 1),
(5, 1, '123456', 'Camisetas poliester', '<p>Camisetas en polialgodon, con dise&ntilde;o exclusivo y estampacion en punto corazon</p>', '42000.00', 12, NULL, '2022-08-15 13:41:22', 'camisetas-poliester', 1),
(6, 2, '12345555', 'Camiseta diseño 1', '<p>Camiseta blanco sin estampacion, puedes escoger que arte</p>', '20000.00', 15, NULL, '2022-08-15 14:15:50', 'camiseta-diseno-1', 1),
(7, 1, '1234567', 'Chaqueta cuero', '<p>100% colombiano</p>', '69000.00', 15, NULL, '2022-08-21 17:37:14', 'chaqueta-cuero', 1);
...
(1, 'yovan', 'yovan-14@hotmail.com', '2022-07-03 04:05:10'),
(2, 'Andres Felipe', 'andres.fffz94@gmail.com', '2022-08-21 12:30:46');
