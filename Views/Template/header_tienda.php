...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/iconfly.png"/>
<!--===============================================================================================-->
	...
	<header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<a href="<?= base_url(); ?>" class="logo">
						<img src="<?= media() ?>/tienda/images/flichil5.png" alt="Tienda Virtual" >
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="<?= base_url(); ?>"><h4>Inicio</h4></a>
							</li>

							<li>
								<a href="<?= base_url(); ?>/tienda"><h4>Nuestra Tienda</h4></a>
							</li>

							<li>
								<a href="<?= base_url(); ?>/carrito"><h4>Carrito</h4></a>
							</li>
							
							<li>
								<a href="<?= base_url(); ?>/nosotros"><h4>Nosotros</h4></a>
							</li>
							...
							<li>
								<a href="<?= base_url(); ?>/contacto" ><h4>Contactanos</h4></a>
							</li>
						</ul>
					</div>	
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-modal-search">
							<h4><i class="zmdi zmdi-search"></i></h4>
						</div>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/flichil5.png" alt="Tienda Virtual"></a>
			</div>
