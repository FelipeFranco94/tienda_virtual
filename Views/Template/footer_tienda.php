	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<form id="frmSuscripcion" name="frmSuscripcion">
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="text" id="nombreSuscripcion" name="nombreSuscripcion" placeholder="Ingrese su Nombre completo" required>
							<div class="focus-input1 trans-04"></div>
						</div>
						<br>
						<div class="wrap-input1 w-full p-b-4">
							<input class="input1 bg-none plh1 stext-107 cl7" type="email" id="emailSuscripcion" name="emailSuscripcion" placeholder="Ingrese su correo" required >
							<div class="focus-input1 trans-04"></div>
						</div>
			...
			<div style="float: right;">
					<p>Tecnologos ADSI</p>
					<p>
						Andrés Felipe Franco <br>
						Santiego Gutierrez <br>
						Yovan Cardenas
					</p>
				</div>
			<div class="p-t-40">
